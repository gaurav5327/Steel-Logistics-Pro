      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              AI-powered logistics optimization platform for integrated steel plants.
              Streamlining port-plant operations across eastern India with intelligent
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/optimization" className="text-gray-300 hover:text-blue-400 transition duration-300">
                  Optimization
                </Link>
              </li>
              <li>
                <Link to="/predictions" className="text-gray-300 hover:text-blue-400 transition duration-300">
                  AI Predictions
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 Steel Logistics Pro. All rights reserved.
          </p>
